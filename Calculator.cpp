...
try {
	...
	cout << "To calculate any expression, kindly use of the following operators[(,),-,+,/,%,=,*, sqrt()].\n" ;
	cout << "To declare any variable, make use of '#' beside the intended declared variable" ;
    cout << "For your result to be printed, kindly press ';' and 'x' to exit the code" ;
...
double primary()
{
	...
	// Unable to calculate the power function
	default:
